...
<body>
   <header role="banner" class="navbar navbar-fixed-top navbar-inverse">
    ...
    <div class="container works">HotSauce Food App</div>
    <div class="row">
      ...
      <div class="equal-height col-md-3 col-sm-6 col-xs-12">
        <img src="http://localhost/me/index.php/../images/hotsauce/hotsaucesignup.png" alt="Avatar" class="image" style="width:100%">
      </div>
      <div class="equal-height col-md-3 col-sm-6 col-xs-12">
        <img src="http://localhost/me/index.php/../images/hotsauce/hotsaucesignin.png" alt="Avatar" class="image" style="width:100%">
      </div>
      <div class="equal-height col-md-3 col-sm-6 col-xs-12">
        <img src="http://localhost/me/index.php/../images/hotsauce/hotsaucecategory.png" alt="Avatar" class="image" style="width:100%">
      </div>
      <div class="equal-height col-md-3 col-sm-6 col-xs-12">
        <img src="http://localhost/me/index.php/../images/hotsauce/hotsaucemenu.png" alt="Avatar" class="image" style="width:100%">
      </div>
      <div class="equal-height col-md-3 col-sm-6 col-xs-12">
        <img src="http://localhost/me/index.php/../images/hotsauce/hotsaucefood.png" alt="Avatar" class="image" style="width:100%">
      </div>
    </div>
      <?php 
