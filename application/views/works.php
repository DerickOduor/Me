...
<body>
   <header role="banner" class="navbar navbar-fixed-top navbar-inverse">
            <div class="container">
                ...
                <div class="navbar-inverse side-collapse in">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="http://localhost/me/index.php/home/works"><span class="glyphicon glyphicon-wrench"></span>&nbsp;Works</a></li>
    ...
    <div class="container works">Check out some of my works.</div>
    <div class="row">
      <div class="equal-height col-md-3 col-sm-6 col-xs-12">
        <img src="http://localhost/me/index.php/../images/legrand/legrand_.png" alt="Avatar" class="image" style="width:100%">
        <div class="middle">
          <div class="text"><a href="http://localhost/legrand/"target="_blank">Legrand Online Store</a></div>
        </div>
      </div>
      <div class="equal-height col-md-3 col-sm-6 col-xs-12">
        <img src="http://localhost/me/index.php/../images/legrand/home.png" alt="Avatar" class="image" style="width:100%">
        <div class="middle">
          <div class="text"><a href="http://localhost/me/index.php/home/legrandApp"target="_blank">Legrand Android App</a></div>
        </div>
      </div>
      <div class="equal-height col-md-3 col-sm-6 col-xs-12">
        <img src="http://localhost/me/index.php/../images/hotsauce/hotsaucehome.png" alt="Avatar" class="image" style="width:100%">
        <div class="middle">
          <div class="text"><a href="http://localhost/me/index.php/home/hotsauceApp"target="_blank">HotSauce Food App</a></div>
        </div>
      </div>
      <div class="equal-height col-md-3 col-sm-6 col-xs-12">
        <img src="http://localhost/me/index.php/../images/med/med.png" alt="Avatar" class="image" style="width:100%">
        <div class="middle">
          <div class="text"><a href="http://localhost/me/index.php/home/#">Sanatorium Outpatient System</a></div>
        </div>
      </div>
    </div>
      <?php 
